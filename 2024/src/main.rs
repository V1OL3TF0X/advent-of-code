...
fn get_all_solution_fns() -> IntoIter<TaskFns, AOC_PROBLEM_NO> {
    [
        ...
        TaskFns {
            task_1: Box::new(aoc_2024::day_18::task_1),
            task_2: Box::new(aoc_2024::day_18::task_2),
        },
        TaskFns {
            task_1: Box::new(aoc_2024::day_19::task_1),
            task_2: Box::new(aoc_2024::day_19::task_2),
        },
        TaskFns {
            task_1: Box::new(aoc_2024::day_20::task_1),
            task_2: Box::new(aoc_2024::day_20::task_2),
        },
        TaskFns {
        ...
        TaskFns {
            task_1: Box::new(aoc_2024::day_23::task_1),
            task_2: Box::new(aoc_2024::day_23::task_2),
        },
        TaskFns {
            task_1: Box::new(aoc_2024::day_24::task_1),
            task_2: Box::new(aoc_2024::day_24::task_2),
        },
        TaskFns {
            task_1: Box::new(aoc_2024::day_25::task_1),
            task_2: Box::new(aoc_2024::day_25::task_2),
        },
    ]
    .into_iter()
}
