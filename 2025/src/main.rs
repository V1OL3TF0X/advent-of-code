...
use aoc_2025::utils::{get_input, get_sample_input, measure_elapsed};
use clap::{Parser, ValueEnum};

const AOC_PROBLEM_NO: usize = 1;
...
fn get_all_solution_fns() -> IntoIter<TaskFns, AOC_PROBLEM_NO> {
    [
        TaskFns {
            task_1: Box::new(aoc_2025::day_1::task_1),
            task_2: Box::new(aoc_2025::day_1::task_2),
        },
        /*TaskFns {
